...
INSERT INTO `tbl_barang` (`id_barang`, `kd_barang`, `nm_barang`, `hrg_jual_khusus`, `hrg_jual_umum`, `satuan`, `stok_opname`, `kd_kategori`) VALUES
	(1, 'P001', 'YamaTube', 50000, 65000, 'Botol', 0, 'K001');
INSERT INTO `tbl_barang` (`id_barang`, `kd_barang`, `nm_barang`, `hrg_jual_khusus`, `hrg_jual_umum`, `satuan`, `stok_opname`, `kd_kategori`) VALUES
	(2, 'P002', 'Busy', 18000, 20000, 'Buah', 360, 'K002');
...
-- Dumping data for table db_inventoryracing.tbl_kategori: ~3 rows (approximately)
...
-- Dumping data for table db_inventoryracing.tbl_pelanggan: ~2 rows (approximately)
...
-- Dumping data for table db_inventoryracing.tbl_pembelian: ~2 rows (approximately)
...
INSERT INTO `tbl_pembelian` (`id_pembelian`, `no_pembelian`, `tgl_pembelian`, `kd_supplier`, `kd_user`) VALUES
	(2, 'B002', '2020-06-14', 'S01', 'U01');
INSERT INTO `tbl_pembelian` (`id_pembelian`, `no_pembelian`, `tgl_pembelian`, `kd_supplier`, `kd_user`) VALUES
	(3, 'B003', '2020-06-14', 'S01', 'U01');
INSERT INTO `tbl_pembelian` (`id_pembelian`, `no_pembelian`, `tgl_pembelian`, `kd_supplier`, `kd_user`) VALUES
	(4, 'B004', '2020-06-15', 'S01', 'U01');
INSERT INTO `tbl_pembelian` (`id_pembelian`, `no_pembelian`, `tgl_pembelian`, `kd_supplier`, `kd_user`) VALUES
	(5, 'B005', '2020-06-16', 'S01', 'U01');
INSERT INTO `tbl_pembelian` (`id_pembelian`, `no_pembelian`, `tgl_pembelian`, `kd_supplier`, `kd_user`) VALUES
	(6, 'B006', '2020-06-17', 'S01', 'U01');
INSERT INTO `tbl_pembelian` (`id_pembelian`, `no_pembelian`, `tgl_pembelian`, `kd_supplier`, `kd_user`) VALUES
	(7, 'B007', '2020-06-18', 'S01', 'U01');
INSERT INTO `tbl_pembelian` (`id_pembelian`, `no_pembelian`, `tgl_pembelian`, `kd_supplier`, `kd_user`) VALUES
	(8, 'B008', '2020-06-19', 'S01', 'U01');
INSERT INTO `tbl_pembelian` (`id_pembelian`, `no_pembelian`, `tgl_pembelian`, `kd_supplier`, `kd_user`) VALUES
	(9, 'B009', '2020-06-20', 'S01', 'U01');
INSERT INTO `tbl_pembelian` (`id_pembelian`, `no_pembelian`, `tgl_pembelian`, `kd_supplier`, `kd_user`) VALUES
	(10, 'B010', '2020-06-21', 'S01', 'U01');
...
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(1, 'B001', 'P002', 40000, 48);
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(2, 'B002', 'P002', 39000, 12);
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(3, 'B003', 'P002', 39500, 24);
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(4, 'B004', 'P002', 37500, 60);
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(5, 'B005', 'P002', 40250, 36);
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(6, 'B006', 'P002', 40100, 12);
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(7, 'B007', 'P002', 38750, 24);
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(8, 'B008', 'P002', 39250, 36);
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(9, 'B009', 'P002', 39900, 48);
INSERT INTO `tbl_pembelian_barang` (`id_pembelian_barang`, `no_pembelian`, `kd_barang`, `harga_beli`, `jumlah`) VALUES
	(10, 'B010', 'P002', 40300, 60);
...
-- Dumping data for table db_inventoryracing.tbl_supplier: ~0 rows (approximately)
